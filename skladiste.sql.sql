...
INSERT INTO racun (ID_zaposlenik, datum_izdavanja, ID_firma) values (1, 32, STR_TO_DATE('05.11.2023.', '%d.%m.%Y.'), 5),
...
-- 1. provjera dostupnosti proizvoda na skladištu i ispis količine
DELIMITER //
...
-- Praćenje narudžbi iz privremenih tablica
...
-- Izračunavanje ukupnog iznosa za svaki račun
